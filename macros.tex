...
\vfill\eject
\fi
\ifodd\pageno\leftpagetrue\else\leftpagefalse\fi
\ifdim\pagetotal=0pt\startpagetrue\else\startpagefalse\fi
\ifdim\wd1>\colwidth\columnablefalse\else\columnabletrue\fi
\typesetsong{#1}
}
%
...
\def\openleft{
\vfill\eject
\ifodd\pageno\hbox{}\vfill\eject\fi
}
%
...
\def\typesetsimple{
\typesetsimplesoft
\ifsuccess\else\openleft\typesetsimpleforce\fi
}
%
...
\currentspaceleft=\pagegoal
\advance\spaceleft by -\pagetotal
\advance\spaceleft by -\ht2
\setbox4=\vsplit 3 to \spaceleft
\ifdim \ht3 = 0pt
\successtrue
\box2
\box4
...
\advance\spaceleft by -\ht2
\box2
\vsplit 3 to \spaceleft
\def\step{
\ifdim\ht3>0pt
\vfill\eject
\vsplit 3 to \pagegoal
\step
\fi
}
\step
...
\setbox11 = \vbox{\unvbox{\vsplit 10 to 0.5\ht10}}
\setbox12 = \hbox to \hsize{\hbox{\box11}\hfil\hbox{\box10}}
\setbox10 = \copy #1\relax
\setbox11 = \vbox{\unvbox{\vsplit 10 to 0.5\ht10}\vskip\blockseparator\unvbox{\vsplit 10 to 0pt}}
\setbox11 = \hbox to \hsize{\hbox{\box11}\hfil\hbox{\box10}}
\ifdim\ht11 > \ht12
\setbox#1=\box12
\else
\setbox#1=\box11
...
%
\def\split#1#2#3{
\setbox#2 = \hbox to \hsize{\hbox{\vsplit #1 to #3}\hfil\hbox{\vsplit #1 to #3}}
}
%
